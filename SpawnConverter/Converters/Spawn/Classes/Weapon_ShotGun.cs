...
{
    public class Weapon_ShotGun : Template_Section, ICSE_ALife_Dynamic_Object_Visual, ICSE_ALife_Inventory_Item, ICSE_ALife_Item_Weapon, ICSE_ALife_Item_Weapon_Magazined
    {
        // =============== BASIC ===============
        ...
        private protected override void ReadUpdate(XrFileReader reader)
        {
            if (!reader.Eof())
            {
                ...
                UPD_Ammo_Count = reader.ReadByte();
            }
        }
    }
}
