...
{
    public class Zone_Visual : Template_Section, ICSE_Shape, ICSE_ALife_Space_Restrictor, ICSE_ALife_Custom_Zone, ICSE_ALife_Anomalous_Zone
    {
        // =============== BASIC ===============
        // CSE_Shape
        ...
        public Zone_Visual(XrFileReader reader) : base(reader) => TypeName = GetType().Name;
        ...
        private protected override void ReadBasic(XrFileReader reader)
        {
            ...
            Visual_Name = reader.ReadStringZ();
            Visual_Flags = reader.ReadByte();
            Startup_Animation = reader.ReadStringZ();
            Attack_Animation = reader.ReadStringZ();
