...
{
    public class Weapon : Template_Section, ICSE_ALife_Dynamic_Object_Visual, ICSE_ALife_Inventory_Item, ICSE_ALife_Item_Weapon, ICSE_ALife_Item_Weapon_Magazined
    {
        // =============== BASIC ===============
        ...
        public Weapon(XrFileReader reader) : base(reader) => TypeName = GetType().Name;
